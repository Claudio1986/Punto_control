...
public class DAOContulmo 
{
	private static Log _log=LogFactory.getLog(DAOContulmo.class);
	...
	public static void delete(String id_control) throws Exception {
		...
		try {
			...
			Contulmo obj = (Contulmo)session.get(
					Contulmo.class, id_control);
			if (obj != null) {
				session.delete(obj);
				session.flush();
			}
	 ...
	 * 
	 */
	public static void add(Contulmo objeto) throws Exception {
		Session session = null;
		try {
			session = HibernateSessionUtil.openSession();
			session.beginTransaction();
	 ...
	 * 
	 */
	public static Contulmo get(String id_control) throws Exception {
		Session session = null;

		try {
			session = HibernateSessionUtil.openSession();
			session.beginTransaction();
			Contulmo objeto = (Contulmo)session.get(
					Contulmo.class, id_control);
			session.getTransaction().commit();
			return objeto;
		}
	 ...
	 * 
	 */
	public static List<Contulmo> list(  String nombre_chofer
											,String patente
											,Date fechaDesde
											,Date fechaHasta
											,String rut_chofer
		...
		try {
			session = HibernateSessionUtil.openSession();
			session.beginTransaction();
			Criteria criteria=session.createCriteria(Contulmo.class);
	 ...
	 * 
	 */
	public static void update(Contulmo objeto) throws Exception {
		Session session = null;
